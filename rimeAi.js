...
dispatcher.onPost("/make-call", async function (req, res) {
  ...
  const client = twilio(process.env.TWILIO_ACCOUNT_SID, process.env.TWILIO_AUTH_TOKEN);
    ...
    const call = await client.calls.create({
        ...
        to: correctNumber,
        method: 'POST',
        url: `https://0db5-182-68-21-25.ngrok-free.app/twiml`,
      });
 ...
 // mediaStream.connection.sendUTF(messageJSON);
  ...
  const options = {
    ...
    headers: {
      ...
      Authorization: 'Bearer WyzgUJeWX5c-NxUx5xSLA8odrZs9ZUoDNH0VMd2iqP0',
      'Content-Type': 'application/json'
    },
    body: `{"speaker":"ana","text":${full_msg},"modelId":"mist", "speedAlpha":1.0,"reduceLatency":false}`
  };
